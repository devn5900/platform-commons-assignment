...
<div className="w-[40%] m-auto max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8  ">
   ...
   <button type="button" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Place Order {`( $${totalPrice} )`}</button>
   </div>
</div>
